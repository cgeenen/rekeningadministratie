...
public class ProvinceNameTest {
    ...
    private static final Logger LOG = Logger.getLogger(ProvinceNameTest.class.getName());

    /**
     * Test of values method, of class ProvinceName.
     */
    @Test
    public void testValues() {
        LOG.log(Level.INFO, "Test: ProvinceName.values");
    ...
    /**
     * Test of valueOf method, of class ProvinceName.
     */
    @Test
    public void testValueOf() {
        LOG.log(Level.INFO, "Test: ProvinceName.valueOf");
